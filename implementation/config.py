...
class Config:
    ...
    Attributes:
      ...
      samples_per_prompt: How many independently sampled program continuations to
        ...
        endpoint: Endpoint of the vLLM api.
        tokenizer: Name of the tokenizer to use.
        max_seq_len: Maximum length of the input sequence.
        max_generated_tokens: Maximum length of the generated sequence.
        temperature: Temperature of the llm sampling.
        top_k: Number of top tokens to consider for llm sampling.
        top_p: Probability mass threshold for top-k  llm sampling.
        top_p_delta: Maximum deviation of top-p.
        temperature_delta: Maximum deviation of temperature.
    """
